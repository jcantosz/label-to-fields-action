...
var universal_user_agent = __webpack_require__(8399);
// EXTERNAL MODULE: ./node_modules/@octokit/request/dist-bundle/index.js + 1 modules
var dist_bundle = __webpack_require__(3434);
// EXTERNAL MODULE: ./node_modules/@octokit/request-error/dist-src/index.js
var dist_src = __webpack_require__(5844);
...
async function oauthRequest(request, route, parameters) {
  ...
  if ("error" in response.data) {
    const error = new dist_src/* RequestError */.L(
...
function createOAuthDeviceAuth(options) {
  const requestWithDefaults = options.request || dist_bundle/* request.defaults */.W.defaults({
    headers: {
      "user-agent": `octokit-auth-oauth-device.js/${dist_bundle_VERSION} ${(0,universal_user_agent/* getUserAgent */.i)()}`
    }
  });
...
function createOAuthUserAuth({
  ...
  clientSecret,
  clientType = "oauth-app",
  request = dist_bundle/* request.defaults */.W.defaults({
    headers: {
      "user-agent": `octokit-auth-oauth-app.js/${auth_oauth_user_dist_bundle_VERSION} ${(0,universal_user_agent/* getUserAgent */.i)()}`
    }
  }),
  onTokenCreated,
  ...strategyOptions
  ...
  const state = Object.assign(
    {
      request: dist_bundle/* request.defaults */.W.defaults({
        headers: {
          "user-agent": `octokit-auth-oauth-app.js/${auth_oauth_app_dist_bundle_VERSION} ${(0,universal_user_agent/* getUserAgent */.i)()}`
        }
      }),
      clientType: "oauth-app"
    },
...
function createAppAuth(options) {
  ...
  const request = options.request || dist_bundle/* request.defaults */.W.defaults({
    headers: {
      "user-agent": `octokit-auth-app.js/${dist_node_VERSION} ${(0,universal_user_agent/* getUserAgent */.i)()}`
    }
  });
  const state = Object.assign(
    {
